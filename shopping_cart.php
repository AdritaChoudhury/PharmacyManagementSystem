...
$query="SELECT `id`, `name`, `image`, `price` FROM `shoppingcart`";
...
<div class="productcont">
       <div class="product">
           ...
           <h3 class="productname"><?php echo $name ?></h3>
           <p class="price"><?php echo $price ?></p>
           <a href="addToCart.php?id=<?php echo $row['id'] ?>"><button class="addtocart">Add To Cart</button></a>
       </div>
</div>
